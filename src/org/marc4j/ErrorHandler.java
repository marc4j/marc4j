...
public class ErrorHandler {
     ...
     * is returned when a FATAL error occurs. Although in some instances (a record with a field > 9999 bytes long) a
     * record will be returned that can be used, but it cannot be written back out without causing an error.
     */
     ...
     * entity reference such as &amp; or &quote; which was replaced with the unescaped version.
     */
