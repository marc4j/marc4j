...
public class UnicodeToUnimarc extends CharConverter implements UnimarcConstants {
     ...
     * <p>
     * This method has been modified to return a sequence of &lt;U+XXXX&gt; for any character that does not have
     * a defined codepoint in MARC-8. XXXX is the unicode hex codepoint. This prevents the loss of unicode data.
     * </p>
     *
    ...
    private String processEscapeSequence(Character ch, CodeTableTracker currentTracker) {
        ...
        sb.append(converter.convert(f.out().toString()));
