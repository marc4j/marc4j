...
public class MarcSplitStreamWriter extends MarcStreamWriter {
	...
	public MarcSplitStreamWriter(OutputStream out, int threshhold,
	...
	public MarcSplitStreamWriter(OutputStream out, String encoding,
			int threshhold, String fieldsToSplit) {
	...
	public void write(Record record) {
		...
		while (!doneWithRec) {
			try {
				...
				// data fields
				final Iterator<DataField> i = record.getDataFields().iterator();
