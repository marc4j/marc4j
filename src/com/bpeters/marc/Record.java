...
/**
 * <p><code>Record</code> defines behaviour for a MARC record.  </p>
 *
 ...
 * @author Bas Peters
 */
public class Record extends MarcConstants {

    /** The leader (record label). */
    Leader leader;

    /** A collection of control fields. */
    protected List controlFieldList = new ArrayList();

    /** A collection of data fields. */
    protected List dataFieldList = new ArrayList();
